 ...
 * QeePlay 框架基本库所在路径
 */
define('QPLAY_PATH', rtrim(__DIR__, '/\\') . DS);

/**
 * 确定 QeePlay 是否使用调试模式
 */
defined('QPLAY_DEBUG') or define('QPLAY_DEBUG', false);

/**
 * 定义 QeePlay 版本号
 */
define('QPLAY_VER', 'QEEPLAY-1.0');

/**
 * 返回应用程序对象
 *
 * @return \qeeplay\mvc\App
 */
function app()
{
    return \qeeplay\mvc\App::instance();
}
...
{
    return \qeeplay\mvc\App::instance()->url($action_name, $params);
}
 ...
 * 例如：
 *
 * http://qeeplay.com/admin/index.php?controller=test
 *
 * 返回：
 *
 ...
 *
 * http://qeeplay.com/admin/index.php?controller=test
 * http://qeeplay.com/admin/index.php/path/to
 *
 * 都返回：
 *
 * /admin/index.php
...
/**
 * \qeeplay\debug\Debug::dump() 的简写，用于输出一个变量的内容
 *
